(function() {
    ...
    function adicionarFuncionalidadeSecaoLocal(idKanban, idSecao, funcionalidade) {
        var promisse = Kanban.update({
            _id: idKanban,
            'secoes._id': idSecao
        }, {
            $push: { 'secoes.$.funcionalidades': funcionalidade }
        }, {
            safe: true
        }).exec();
    ...
    function removerFuncionalidadeSecaoLocal(idKanban, idSecao, idFuncionalidade) {
        var promisse = Kanban.update({
            _id: idKanban,
            'secoes._id': idSecao
        }, {
            $pull: { 'secoes.$.funcionalidades': idFuncionalidade }
        }, {
            safe: true
        }).exec();
    ...
    var service = {
        ...
        removerFuncionalidadeSecaoLocal: removerFuncionalidadeSecaoLocal,
        adicionarFuncionalidadeSecaoLocal: adicionarFuncionalidadeSecaoLocal
    };
