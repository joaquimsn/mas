...
function FuncionalidadeService(requestApiService, ModuloService) {
    this.findFuncionalidade = function(callback) {npm 
    ...
    this.syncGitHub = function(callback, funcionalidade, projeto) {
        var sync = {
            tarefa: funcionalidade,
            gitUser: projeto.github
        };

        requestApiService.postNo(callback, sync, '/github/issue');
    };
